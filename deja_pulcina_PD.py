...
class Klients:
    ...
    def nodarbiiba_laiks_info(self, cena, nedelas_dienas, laiks):
...
class Vecaaks:
    ...
    def Vecaaks_info_print(self):
        print("Vecāka vārds: " + str(self.Vecaaka_vaards))
        print("Vecāka uzvārds: " + str(self.Vecaaka_uzvaards))
        print("Vecāka telefona numurs: " + str(self.tel_number))
        print("-" * 100)
 

k1 = Klients("Alīna", "Suškova", "3", "120621-25415", "Rēzekne, Pils iela 1", 25, ["Pirmdiena", "Trešdiena", "Piektdiena"], time(17, 30))
print(f"Klienta ID: {k1.Klienta_id}")
k1.Klienta_info_print()
k1.nodarbiiba_laiks_info(25, ["Pirmdiena", "Trešdiena", "Piektdiena"], time(17, 30))
