#Frizētava
import itertools #ģenerēt unikālus id katram pakalpojumam
import datetime #strādāt ar datiem
from datetime import time #strādāt ar laikiem 

class Pakalpojums:
    Pakalpojuma_kategorija = " "
    Pakalpojuma_nosaukums = " "
    Pakalpojuma_atlaide = " "
    Pakalpojuma_cena = 0 #tukšas vērtības
    id_iter = itertools.count() #id_iter izmantots kā skatītais, kass sākas no nulles un palielinās par 1 katru reizi, lai katrs pakalpojums iegūtu unikālu ID.

    def __init__(self, pak_kat=None, pak_nos=None, pak_atl=None, pak_cena=10):
        self.Pakalpojuma_id = next(self.id_iter)
    ...
    def Pakalpokuma_info_print(self):
        print("Pakalpojuma kategotija: " + str(self.Pakalpojuma_kategorija))
        ...
        print("Laika pieejams: " + str(self.Laiks_pieejams) + "\n")
...
class Klients:
    ...
    def klienta_info(self):
        return[
            self.Klienta_vaards, self.Klienta_uzvaards,
            self.Klienta_PK, self.Klienta_tel_numurs
        ]
    
    def klients_info_print(self):
        print("Klienta vārds: " + str(self.Klienta_vaards))
        print("Klienta uzvārds: " + str(self.Klienta_uzvaards))
        print("Klienta kods: " + str(self.Klienta_PK))
...
pak1 = Pakalpojums("Frizētāvā", "Matu griešana", "20%", 30)
print(pak1.Pakalpojuma_id)
pak1.Pakalpojuma_info()
pak1.Pakalpokuma_info_print()

kl1 = Klients("Alīna", "Suškova", 230502-21457, 20221035)
